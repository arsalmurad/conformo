 ...
 * one place HTML sanitisation on rich input actually applies. Every other
 * field is a single line of structured data (a name, an amount, a code);
 * this is the only one meant to hold whatever the user wants to say. */
